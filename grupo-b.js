...
document.querySelector("#cards").innerHTML = 
    createCard("1ª RODADA", createGame("england", "21/11(Seg) - 10:00", "iran") + createGame("usa", "21/11(Seg) - 16:00", "wales")) +
    createCard("2ª RODADA", createGame("wales", "25/11(Sex) - 7:00", "iran") + createGame("england", "25/11(Sex) - 16:00", "usa")) +
    createCard("3ª RODADA", createGame("iran", "29/11(Ter) - 16:00", "usa") + createGame("wales", "29/11(Ter) - 16:00", "england"))  
...
function createFlags(flag1, flag2, flag3, flag4) {
    return `
    <ul>
    <li><img src="./assets/icon-${flag1}.svg" alt="Bandeira ${flag1}"><scan>Estados Unidos</scan></li><br>     
    <li><img src="./assets/icon-${flag2}.svg" alt="Bandeira ${flag2}"><scan>Inglaterra</scan></li><br>
    <li><img src="./assets/icon-${flag3}.svg" alt="Bandeira ${flag3}"><scan>Irã</scan></li><br>
    <li><img src="./assets/icon-${flag4}.svg" alt="Bandeira ${flag4}"><scan>País de Gales</scan></li><br>
    </ul>
    `
}
// ******************** PERSONALIZAR VALORES DA FUNÇÃO createFlags ********************
document.querySelector("#bandeiras").innerHTML =
    createFlags("usa", "england", "iran", "wales")